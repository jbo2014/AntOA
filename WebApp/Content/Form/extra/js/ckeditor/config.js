...
CKEDITOR.editorConfig = function (config) {
    ...
    config.toolbar_Basic =
		[{
		    name: 'basicstyles',
		    items: ['Bold', 'Italic', 'NumberedList', 'BulletedList', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock', 'Link', 'Unlink']
		}, {
		    name: 'clipboard',
		    items: ['Font', 'FontSize', 'TextColor', 'BGColor', 'Image', 'Smiley', '-', 'Templates', 'Source', 'Maximize']
		}];
    ...
    config.toolbar_Form =
		[{
		    ...
		    name: "about",
		    items: ["About", "ShowBlocks", "Maximize"]
		},
			"/", {
			    name: "style",
			    items: ["Styles", "Format", "Font", "FontSize"]
    ...
    //"/",
    //{name:"tdforms",items:"TdTextField TdTextarea TdSelect TdRadio TdCheckbox TdHiddenField - Cdxdtpicker Suseranddept Listview Countersign Signature Writesign Dimensionalcode Macro Tcount".split(" ")}];
