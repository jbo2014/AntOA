...
CKEDITOR.config.menu_groups = 'clipboard,' +
	...
	'remove,checkbox,tdcheckbox,radio,tdradio,textfield,hiddenfield,tdhiddenfield,tdtextfield,cdxdtpicker,suseranddept,listview,signature,writesign,dimensionalcode,macro,tcount,countersign,fileupload,syscode,flowcomment,imagebutton,button,select,tdselect,textarea,tdtextarea,div';
