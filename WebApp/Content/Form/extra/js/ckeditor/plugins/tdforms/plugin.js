 ...
 */
        ...
        CKEDITOR.plugins.add('tdforms', {
            ...
            lang: 'en,zh,zh-cn',
            icons: 'tdcheckbox,tdhiddenfield,tdradio,tdselect,tdtextarea,tdtextfield,cdxdtpicker,suseranddept,listview,countersign,jsEditor,cssEditor,signature,writesign,dimensionalcode,macro,tcount,fileupload,syscode,flowcomment', // %REMOVE_LINE_CORE%
            onLoad: function() {
            ...
            init: function(editor) {
                var lang = editor.lang,
                        order = 0,
                        textfieldClasses = {user: 1, dept: 1},
                textfieldTypes = {email: 1, password: 1, search: 1, tel: 1, text: 1, url: 1},
                dateType = {date: 1, datetime: 1, custom: 1};
                ...
                addButtonCommand('Writesign', 'writesign', dialogPath + 'writesign.js');//手写签章
                addButtonCommand('Dimensionalcode', 'dimensionalcode', dialogPath + 'dimensionalcode.js');//二维码控件
                addButtonCommand('Macro', 'macro', dialogPath + 'macro.js');//宏控件
                addButtonCommand('Tcount', 'tcount', dialogPath + 'tcount.js');//自动编号
                addButtonCommand('Countersign', 'countersign', dialogPath + 'countersign.js');//会签控件
                addButtonCommand('Fileupload', 'fileupload', dialogPath + 'fileupload.js');//附件控件
                addButtonCommand('SysCode', 'syscode', dialogPath + 'syscode.js');//系统代码选择
                addButtonCommand('FlowComment', 'flowcomment', dialogPath + 'flowcomment.js');
                ...
                if (editor.addMenuItems) {
                    var items = {
                        ...
                        macro: {
                            label: lang.tdforms.macro.dialogTitle,
                            command: 'macro',
                            group: 'macro'
                        },
                        tcount: {
                            label: lang.tdforms.tcount.dialogTitle,
                            command: 'tcount',
                            group: 'tcount'
                        },
                        countersign: {
                            label: lang.tdforms.countersign.dialogTitle,
                            command: 'countersign',
                            group: 'countersign'
                        },
                        fileupload: {
                            label: lang.tdforms.fileupload.dialogTitle,
                            command: 'fileupload',
                            group: 'fileupload'
                        },
                        syscode: {
                            label: lang.tdforms.syscode.dialogTitle,
                            command: 'syscode',
                            group: 'syscode'
                        },
                        flowcomment: {
                            label: lang.tdforms.flowcomment.dialogTitle,
                            command: 'flowcomment',
                            group: 'flowcomment'
                        }
                    };
